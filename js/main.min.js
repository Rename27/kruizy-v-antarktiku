...
/* harmony import */ var _modules_modals_nav_toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/nav-toggle */ "./js/modules/modals/nav-toggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_nav_toggle__WEBPACK_IMPORTED_MODULE_2__["navToggle"])();
}); // ---------------------------------
...
var headerLogo = pageBody.querySelector('.header__logo');
var navOverlay = pageBody.querySelector('.nav__overlay');
var navToggleButton = pageBody.querySelector('.nav__toggle-button');
var navLinks = pageBody.querySelectorAll('.nav__link');
...
=======
/*! exports provided: navToggle */function(e,t,n){"use strict";n.r(t),n.d(t,"navToggle",(function(){return u}));var o=document.querySelector(".page__body"),s=o.querySelector(".main"),i=o.querySelector(".header__logo"),l=o.querySelector(".nav__overlay"),c=o.querySelector(".nav__toggle-button"),a=o.querySelectorAll(".nav__overlay a");l.classList.remove("nav__overlay--jsnone");var r=function(){l.classList.add("nav__overlay--is-close"),l.classList.remove("nav__overlay--is-open"),c.classList.remove("nav__toggle-button--is-open"),c.classList.add("nav__toggle-button--is-close"),i.style.visibility="visible",o.style.overflowY="scroll"},u=function(){c.addEventListener("click",(function(){c.classList.contains("nav__toggle-button--is-close")?(l.classList.remove("nav__overlay--is-close"),l.classList.add("nav__overlay--is-open"),c.classList.remove("nav__toggle-button--is-close"),c.classList.add("nav__toggle-button--is-open"),i.style.visibility="hidden",o.style.overflowY="hidden",s.addEventListener("click",r)):r(),a.forEach((function(e){e.addEventListener("click",r)}))}))}},"./js/utils/focus-lock.js":
>>>>>>> d51dee9a66c101df3d5361c5c74228cefe2a3171:js/main.min.js
/*!********************************!*\
  !*** ./js/utils/focus-lock.js ***!
  \********************************/
